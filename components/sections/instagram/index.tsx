        ...
        <div className="p-4">
          ...
          >
            ...
            <div className="flex items-center">
              {' '}
              <div className="bg-[#F4F4F4] rounded-[50%] grow-0 h-10 mr-[14px] w-10"></div>{' '}
              <div className="flex flex-col grow-[1] justify-center">
                {' '}
                <div className="bg-[#F4F4F4] rounded-[4px] grow-0 h-[14px] mb-[6px] w-full"></div>{' '}
                <div className="bg-[#F4F4F4] rounded-[4px] grow-0 h-[14px] w-[60px]"></div>
              </div>
            </div>
            <div className="p-[19%]"></div>{' '}
            <div className="h-[50px] m-0ad w-[50px]">
              <svg
                width="50px"
                height="50px"
                viewBox="0 0 60 60"
            ...
            <div className="pt-2">
              {' '}
              <div className="text-[#3897f0] font-arial-Sans text-[14px] [font-style:normal] font-[550] leading-[18px]">
                Ver essa foto no Instagram
              </div>
            </div>
            <div className="p-instagram"></div>{' '}
            <div className="flex mb-[14px] items-center">
              <div>
                {' '}
                <div className="bg-[#F4F4F4] rounded-half h-[12.5px] w-[12.5px] transform translate-x-zero translate-y-zero"></div>{' '}
